          ...
          exports.txt = {
            ...
            "requested": {
              ...
              "teacherApproved": {
                ...
                "description": "You are now part of the {organization} institution, Start using AILearn."
              },
              "student": {
              ...
              "studentApproved": {
                "title": "Congratulations! Your request has been approved",
                "description": "You are now part of the classroom, Start using AILearn."
              },
              "institution": {
            ...
            "teacher": {
              ...
              "institution": {
                "intro": {
                  ...
                  "title": "Does the institution where you work use AILearn?",
                  "description": "My institution already works with <strong>AILearn</strong> Rivadavia and I want to join its educational space.",
                  "options": {
                    "yes": {
                      "label": "Yes",
                      "description": "My institution already works with <strong>AILearn</strong> and I want to join its educational space."
                    },
                    "no": {
                      "label": "No",
                      "description": "My institution does not work with <strong>AILearn</strong>. I want to join the tool as an independent teacher."
                    }
                  }
                },
                "form": {
                  "title": "Start the educational transformation",
                  "description": "You are about to join your institution's educational space. To access AILearn, you must validate the access code provided by your institution's administrator.",
                  "form": {
                    "legend": {
              ...
              "welcome": {
                "user": {
                  "hello": "Hello {username}!",
                  "description": "Welcome to AILearn"
                }
              },
              "processed": {
