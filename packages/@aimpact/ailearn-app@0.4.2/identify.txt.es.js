          ...
          exports.txt = {
            ...
            "requested": {
              ...
              "teacherInstitution": {
                ...
                "description": "Por favor, espera la aprobación del administrador para acceder al espacio educativo de la institución. <strong>Revisa tu correo electrónico</strong> donde te notificaremos una vez que tu solicitud haya sido aprobada para poder acceder a <strong>AILearn</strong>."
              },
              "teacherApproved": {
                "title": "¡Felicitaciones! Tu solicitud ha sido aprobada",
                "description": "Ya eres parte de la institución {organization}, Comienza a utilizar AILearn."
              },
              "student": {
                "title": "Tu solicitud para unirte al aula está en proceso de revisión.",
                "description": "Por favor, espera la aprobación del profesor para acceder al aula. <strong>Revisa tu correo electrónico</strong> donde te notificaremos una vez que tu solicitud haya sido aprobada para poder acceder a <strong>AILearn</strong>."
              },
              "studentApproved": {
                "title": "¡Felicitaciones! Tu solicitud ha sido aprobada",
                "description": "Ya eres parte del aula, Comienza a utilizar AILearn."
              },
              "institution": {
            ...
            "teacher": {
              ...
              "institution": {
                "intro": {
                  "hello": "Hola {username}",
                  "title": "¿La institución donde trabajas utiliza AILearn?",
                  "description": "Mi institución ya trabaja con <strong>AILearn</strong> Rivadavia y quiero sumarme a su espacio educativo.",
                  "options": {
                    "yes": {
                      "label": "Sí",
                      "description": "Mi institución ya trabaja con <strong>AILearn</strong> y quiero sumarme a su espacio educativo."
                    },
                    "no": {
                      "label": "No",
                      "description": "Mi institución no trabaja con <strong>AILearn</strong>. Quiero sumarme a la herramienta como docente independiente."
                    }
                  }
                },
                "form": {
              ...
              "welcome": {
                "user": {
                  "hello": "¡Hola {username}!",
                  "description": "Bienvenido a AILearn"
                }
              },
              "processed": {
            ...
            "welcome": {
              "hello": "¡Hola {username}!",
              "description": "Bienvenido/a a AILearn"
            },
            "actions": {
              "accept": "ACEPTAR",
              "back": "VOLVER",
