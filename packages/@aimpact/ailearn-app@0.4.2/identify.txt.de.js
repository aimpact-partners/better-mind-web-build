          ...
          exports.txt = {
            ...
            "requested": {
              ...
              "teacherApproved": {
                ...
                "description": "Sie sind jetzt Teil der Institution {organization}. Beginnen Sie mit der Nutzung von AILearn."
              },
              "student": {
              ...
              "studentApproved": {
                "title": "Herzlichen Glückwunsch! Ihre Anfrage wurde genehmigt",
                "description": "Sie sind jetzt Teil des Klassenraums. Beginnen Sie mit der Nutzung von AILearn."
              },
              "institution": {
            ...
            "student": {
              "selection": {
                ...
                "description": "Um Ihre Lernerfahrung mit AILearn zu beginnen, können Sie den Lehrer nach dem Zugangscode für den Klassenraum fragen und diesen eingeben, um fortzufahren, oder den Zugangslink zu einer Aktivität anfordern. Sobald Sie diese Informationen haben, können Sie das Lernmodul betreten und mit der Erkundung der speziell für Sie entwickelten Inhalte beginnen."
              },
              "form": {
                "title": "Beginnen Sie Ihre Bildungstransformation",
                "description": "Sie sind dabei, dem Bildungsraum Ihrer Institution beizutreten. Um AILearn zu betreten, müssen Sie den vom Administrator Ihrer Institution bereitgestellten Zugangscode validieren.",
                "form": {
                  "legend": {
            ...
            "teacher": {
              ...
              "institution": {
                "intro": {
                  ...
                  "title": "Verwendet die Institution, in der Sie arbeiten, AILearn?",
                  "description": "Meine Institution arbeitet bereits mit <strong>AILearn</strong> Rivadavia und ich möchte ihrem Bildungsraum beitreten.",
                  "options": {
                    "yes": {
                      "label": "Ja",
                      "description": "Meine Institution arbeitet bereits mit <strong>AILearn</strong> und ich möchte ihrem Bildungsraum beitreten."
                    },
                    "no": {
                      "label": "Nein",
                      "description": "Meine Institution arbeitet nicht mit <strong>AILearn</strong>. Ich möchte dem Tool als unabhängiger Lehrer beitreten."
                    }
                  }
                },
                "form": {
                  "title": "Beginnen Sie die Bildungstransformation",
                  "description": "Sie sind dabei, dem Bildungsraum Ihrer Institution beizutreten. Um auf AILearn zuzugreifen, müssen Sie den vom Administrator Ihrer Institution bereitgestellten Zugangscode validieren.",
                  "form": {
                    "legend": {
              ...
              "welcome": {
                "user": {
                  "hello": "Hallo {username}!",
                  "description": "Willkommen bei AILearn"
                }
              },
              "processed": {
